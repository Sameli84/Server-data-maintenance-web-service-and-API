...
public class CourseSchemaPart implements Serializable {
    ...
    public CourseSchemaPart(String name, boolean validator, String validatorRegex, String validatorMessage, boolean locked, boolean autogenerated, String generationStatement, int controlWidth, int order, boolean required, Course course) {
        this.name = name;
