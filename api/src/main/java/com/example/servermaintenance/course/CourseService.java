...
public class CourseService {
    ...
    public Course createCourse(CourseSchemaDto courseSchemaDto, Account account) {
        ...
        for (int i = 0; i < courseSchemaDto.getParts().size(); i++) {
            ...
            var part = new SchemaPart(p.getName(), p.isValidator(), p.getValidatorRegex(), p.getValidatorMessage(), p.isLocked(), p.isAutogenerated(), p.getGenerationStatement(), p.getControlWidth(), i, p.isRequired(), course);
